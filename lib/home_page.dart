import 'dart:async';
    ...
    class _HomePageState extends State {
        ...
        return Scaffold(
            backgroundColor: Color.fromARGB(255, 66, 26, 88),
            body: SafeArea(
            child: Padding(
                ...
                children: [
                    ...
                    child: Container(
                        ...
                        color: Color.fromARGB(255, 1, 5, 6)
                            ,
                    ...
                    children: [
                        Expanded(
                            ...
                            shape: StadiumBorder(
                                side: BorderSide(color: Color.fromARGB(255, 47, 98, 174))
                        ...
                        Expanded(
                            ...
                            fillColor: Color.fromARGB(255, 40, 124, 180),
                            shape: StadiumBorder(),
                            child: Text('Restart',
                                style: TextStyle(
                                    color: Colors.white
